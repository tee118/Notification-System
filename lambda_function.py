...
def lambda_handler(event, context):
    sns_topic_arn = 'arn:aws:sns:us-east-1:450688257856:notificationsystemtopic'

    # Define the SQS queue URL
    sqs_queue_url = 'https://sqs.us-east-1.amazonaws.com/450688257856/notificationquueue'
